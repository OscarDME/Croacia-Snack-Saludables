// lib/copy.js — todo el copy visible de la landing. Croata, verbatim desde
// loncherafeliz.aprende-hoy.shop. Cualquier cambio de texto ocurre ovdje.
...
export const copy = {
  ...
  benefits: {
    ...
    items: [
      ...
      {
        icon: "🥦",
        title: "Brizima oko prehrane vaše djece",
        desc: "Užine prepune važnih vitamina i minerala koje će svi obožavati.",
      },
      {
        icon: "😩",
        title: "Stresu oko pripreme kompliciranih jela",
  ...
  transformation: {
    ...
    before: {
      tag: "PRIJE",
      title: "Bez energije i nutritivne vrijednosti",
      desc: "Prerađena hrana, puna šećera i aditiva koji ne donose ništa dobro",
    },
    after: {
      tag: "POSLIJE",
      title: "Sretni, živahni i puni energije",
      desc: "Prirodne, ukusne i hranjive užine koje djeca obožavaju",
    },
    image: {
      src: "/kids-transformation.webp",
      alt: "Transformacija: tužno dijete koje jede nezdravu hranu u usporedbi sa sretnim djetetom uz zdrave užine",
    },
  },
    ...
    items: [
      {
        ...
        quote:
          "Nikad nisam vjerovala da će moj sin tako brzo prihvatiti zdrave užine! Recepti su ne samo vrlo jednostavni, već mu se i strašno sviđaju. Hvala vam što ste mi olakšali život! Najbolja investicija koju sam ikada napravila.",
      },
      {
        initial: "N",
        name: "Nikola",
        ...
        quote:
          "Prije sam se jako brinuo o tome što dajem svojoj djeci, ali s ovom knjigom sam pronašao izuzetno ukusne i zdrave opcije. Sada svi jedemo kvalitetnije i puno sam mirniji!",
      },
      {
        initial: "J",
        name: "Jelena",
        ...
        quote:
          "Kao stručnjakinja mogu potvrditi da su ovi recepti savršeno izbalansirani. Moja djeca ih obožavaju, a ja sam mirna znajući da se dobro hrane. Toplo preporučujem svakom roditelju!",
      },
      {
        initial: "D",
        name: "Danijela",
        ...
        quote:
          "Zbog pretrpanog rasporeda nisam imala nimalo vremena za kuhanje. Ova knjiga je promijenila sve: recepti gotovi za 15 minuta koje moja djeca traže iznova i iznova. Vrijedi svake lipe! Već sam je preporučila svim svojim prijateljicama.",
      },
    ],
  },
  ...
  whatYouGet: {
    ...
    items: [
      "500 brzih i hranjivih recepata za doručak, ručak, večeru i školske užine",
    ...
    items: [
      {
        ...
        desc: "Pripremite zdrave verzije njihove omiljene hrane, bez dodanog šećera i glutena, gotove doslovno u nekoliko minuta.",
      },
      {
        value: "19.99 €",
        title: "Praktični vodič za organizaciju i zamrzavanje hrane",
        desc: "Naučite kako sve pripremiti odjednom i imati gotovu hranu za cijeli tjedan uz manje od 30 minuta posla dnevno.",
      },
      {
        value: "14.99 €",
        title: "Posebni recepti za djecu s alergijama",
        desc: "Sigurni i ukusni recepti prilagođeni najčešćim alergijama (mlijeko, jaja, soja, kikiriki).",
      },
      {
        value: "14.99 €",
        title: "Recepti za ukusne i zdrave deserte",
        desc: "Zamijenite prerađene slatkiše korisnim poslasticama napravljenim isključivo od prirodnih sastojaka.",
      },
      {
        value: "14.99 €",
        title: "Zdravi i jednostavni za pripremu svježi sokovi",
        desc: "Praktični recepti za prirodne, hranjive i ukusne sokove koji će osvježiti dan vašim najdražima.",
      },
    ],
  ...
  exclusiveBonuses: {
    ...
    items: [
      {
        value: "18.99 €",
        title: "Domaći voćni gumeni bomboni bogati vitaminom C",
        desc: "Naučite kako napraviti prirodne gumene bombone, bogate vitaminom C, kako biste ojačali imunološki sustav svoje djece na zabavan i ukusan način. Bez dodanog šećera, 100% prirodni i prepuni korisnih tvari!",
      },
      {
        value: "19.99 €",
        title: "Kako navesti djecu da zavole povrće",
        desc: "Pretvorite povrće u ukusnu i zabavnu avanturu za vašu djecu. Jednostavni recepti koji će im pomoći da s ogromnim zadovoljstvom jedu povrće.",
      },
      {
        value: "17.99 €",
        title: "Vodič za brze užine za izbirljivu djecu",
        desc: "Otkrijte jednostavne i hranjive užine, idealne za djecu sa slabim apetitom, koje će im pomoći da se hrane zdravo i vrlo ukusno.",
      },
      {
        value: "17.99 €",
        title: "Vodič kroz superhranu za djecu",
        desc: "Naučite kako uključiti superhranu koja će poboljšati zdravlje i energiju vaše djece kroz jednostavne recepte koji osiguravaju važne hranjive tvari.",
      },
    ],
  ...
  finalCta: {
    ...
    bundleList: [
      ...
      "✅ 9 ekskluzivnih bonusa u vrijednosti od 167.91 € — POTPUNO BESPLATNO!",
    ...
    imageAlt:
      "Cjelokupni paket: E-knjiga Zdrave užine za djecu + 9 bonusa",
  ...
  guarantee: {
    ...
    body: "Toliko smo sigurni da će vam se ovaj priručnik svidjeti da vam nudimo bezuvjetno 14-dnevno jamstvo. Ako iz bilo kojeg razloga niste 100% zadovoljni, vratit ćemo vam svaki cent. Bez suvišnih pitanja i komplikacija.",
    footer: "✅ Zajamčen potpuni povrat novca • ✅ Bez suvišnih pitanja • ✅ Trenutna procedura",
  },
    ...
    items: [
      {
        ...
        a: "Priručnik je namijenjen djeci od 2 do 12 godina, iako se recepti lako mogu prilagoditi apsolutno svim uzrastima.",
      },
      {
        q: "Je li prikladan za djecu s alergijama?",
        a: "Da! Nudimo recepte prilagođene najčešćim alergijama poput mlijeka, jaja, soje i kikirikija, tako da sva djeca mogu uživati u ukusnoj i zdravoj hrani.",
      },
      {
        q: "Moram li biti dobar kuhar?",
        a: "Ne, recepti su osmišljeni tako da ih je iznimno lako pratiti, s malo sastojaka i jednostavnim koracima. Čak i ako niste stručnjak u kuhinji, odlično ćete se snaći!",
      },
      {
        q: "Jesu li sastojci skupi?",
        a: "Ne, svi sastojci su pristupačni i lako ih je pronaći u svakom standardnom supermarketu. Ne trebaju vam skupi ili teško dostupni proizvodi.",
      },
      {
        q: "Koliko traje priprema užina?",
        a: "Recepti su iznimno brzi, a većina užina gotova je za manje od 15 minuta.",
      },
      {
        q: "Mogu li platiti u svojoj lokalnoj valuti?",
        a: "Da! Naš sustav naplate automatski preračunava iznos prema tečaju vaše lokalne valute. Kada prijeđete na plaćanje, vidjet ćete cijenu prilagođenu vašoj valuti, tako da ne morate brinuti o dodatnim troškovima konverzije. Jamčimo da je proces plaćanja jednostavan i potpuno transparentan, bez obzira na vašu lokaciju.",
      },
    ],
  },
  ...
  closing: {
    ...
    headline:
      "Ne propustite ovu jedinstvenu priliku da preobrazite prehranu svoje obitelji!",
    subheadline:
      "Potpuni priručnik + 9 bonusa u vrijednosti od 167.91 € NA POKLON! Sve to po cijeni jedne večere vani",
    regularPrice: "201.00 €",
    offerPrice: "8.90 €",
    ctaLabel: "DA, ŽELIM SVOJ PRIRUČNIK SADA!",
    trustRow:
      "🔒 100% sigurno plaćanje • ⚡ Trenutni pristup • ✅ 14-dnevno jamstvo povrata novca bez rizika",
  },
